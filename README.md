...
**Note:** In some of the unity 2019 versions you don't have the project settings for package manager yet, so for those use the [2018](#Step-1---Unity-2018-and-below) way.
...
This is where you will add the `server IP` or `URL` to the web side of `Play Test Toolkit`.
